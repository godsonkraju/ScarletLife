...
public class Level {
    ...
    public Level(String levelId, char[] cells, String description, String title, int health, int fuel,
                 boolean privateLevel, int difficulty, int rating, String creator, String nextLevel,
                 int fps, int cellLength, Date timeCreated, String levelType, String image, int bulletLimit, Spaceship spaceship) {
